...
function App() {
  ...
  const nav = [['dashboard', 'Overview'], ['customers', 'Customers'], ['cdd', 'KYC / CDD'], ['approvals', `Approvals ${pending.length}`], ['alerts', `Alerts ${openAlerts.length}`], ['cases', `Cases ${openCases.length}`]]
